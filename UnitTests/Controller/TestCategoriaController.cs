...
public class TestCategoriaController
{
    ...
    // Test 1: GET all categorías
    [TestMethod]
    public async Task GetCategorias_DeberiaRetornarOk()
    {
        _mockService.Setup(s => s.ListarCategoriasAsync())
            .ReturnsAsync(new ApiResponse<List<Categorium>>
            {
                IsSuccess = true,
                Data = new List<Categorium> { new Categorium { Id_Categoria = 1, Nombre_Categoria = "Snacks" } }
            });
    ...
    // Test 2: GET categoría por id - existente
    [TestMethod]
    public async Task GetCategoria_DeberiaRetornarOk_SiExiste()
    {
        _mockService.Setup(s => s.ObtenerCategoriaAsync(1))
            .ReturnsAsync(new ApiResponse<Categorium>
            {
                IsSuccess = true,
                Data = new Categorium { Id_Categoria = 1, Nombre_Categoria = "Snacks" }
            });
    ...
    // Test 3: GET categoría por id - inexistente
    [TestMethod]
    ...
    // Test 4: POST registrar categoría - válido
    [TestMethod]
    public async Task RegistrarCategoria_DeberiaRetornarOk_SiValido()
    {
        ...
        _mockService.Setup(s => s.RegistrarCategoriaAsync(nuevaCategoria))
            ...
            {
                IsSuccess = true,
                Message = Mensajes.MESSAGE_REGISTER
            });
    ...
    // Test 5: POST registrar categoría - inválido
    [TestMethod]
    public async Task RegistrarCategoria_DeberiaRetornarBadRequest_SiInvalido()
    {
        ...
        _mockService.Setup(s => s.RegistrarCategoriaAsync(nuevaCategoria))
            ...
            {
                IsSuccess = false,
                Message = Mensajes.MESSAGE_EMPTY
            });
    ...
    // Test 6: PUT editar categoría - válido
    [TestMethod]
    public async Task EditarCategoria_DeberiaRetornarOk_SiValido()
    {
        ...
        _mockService.Setup(s => s.EditarCategoriaAsync(categoria))
            ...
            {
                IsSuccess = true,
                Message = Mensajes.MESSAGE_UPDATE
            });
    ...
    // Test 7: PUT editar categoría - inválido
    [TestMethod]
    ...
    // Test 8: DELETE eliminar categoría - existente
    [TestMethod]
    public async Task EliminarCategoria_DeberiaRetornarOk_SiExiste()
    {
        _mockService.Setup(s => s.EliminarCategoriaAsync(1))
            ...
            {
                IsSuccess = true,
                Message = Mensajes.MESSAGE_DELETE
            });
    ...
    // Test 9: DELETE eliminar categoría - inexistente
    [TestMethod]
