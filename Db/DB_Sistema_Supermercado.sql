...
VALUES('MarketEase','0969810812','0102030405785','Mucho Lote 3 etapa','MarketEase@gmail.com');
GO
...
AS
BEGIN
	UPDATE NEGOCIO set NOMBRE = @Nombre, TELEFONO = @Telefono, RUC = @Ruc, DIRECCION = @Direccion, CORREO_ELECTRONICO = @Correo_Electronico, LOGO = @Logo,
    USUARIO_MODIFICACION = @Usuario_Modificacion WHERE ID_NEGOCIO = @Id_Negocio;
END;
GO
...
VALUES ('00001', 'Abraham Andres Farfan Sanchez', 'hermanosfarfan@gmail.com', CONVERT(VARCHAR(64), HASHBYTES('SHA2_256', '1234qwer/.'), 2), 1, 1);
GO 
...
BEGIN
    ...
    CONVERT(VARCHAR(10), FECHA_CREACION, 23) LIKE @SearchTerm OR CASE WHEN ESTADO = 1 THEN 'Activo' ELSE 'Inactivo' END LIKE @SearchTerm);
...
AS
BEGIN
	INSERT INTO USUARIO(CODIGO, NOMBRE_COMPLETO, CLAVE, CORREO_ELECTRONICO, ID_ROL, ESTADO, USUARIO_CREACION, FECHA_CREACION) 
	values(@Codigo, @Nombre_Completo, @Clave, @Correo_Electronico, @Id_Rol, @Estado, @Usuario_Creacion, GETDATE());
END;
GO
...
BEGIN
    ...
    USUARIO_MODIFICACION = @Usuario_Modificacion, FECHA_MODIFICACION = GETDATE() WHERE ID_USUARIO = @Id_Usuario;
END;
GO
...
SELECT 
    ...
    S.UBICACION_SUCURSAL.Lat AS LATITUD, 
    S.UBICACION_SUCURSAL.Long AS LONGITUD, 
    S.CIUDAD_SUCURSAL, 
    S.ESTADO 
FROM SUCURSAL S
...
BEGIN
    ...
    LONGITUD LIKE @SearchTerm OR CIUDAD_SUCURSAL LIKE @SearchTerm OR CASE WHEN ESTADO = 1 THEN 'Activo' ELSE 'Inactivo' END LIKE @SearchTerm);
...
AS
BEGIN
    SELECT ID_SUCURSAL, CODIGO, O.ID_NEGOCIO, O.NOMBRE AS NOMBRE_NEGOCIO, O.TELEFONO, O.RUC, O.DIRECCION, O.CORREO_ELECTRONICO, NOMBRE_SUCURSAL, 
    DIRECCION_SUCURSAL, UBICACION_SUCURSAL.Lat AS LATITUD, UBICACION_SUCURSAL.Long AS LONGITUD, CIUDAD_SUCURSAL, ESTADO , S.USUARIO_CREACION,
    S.FECHA_CREACION, S.USUARIO_MODIFICACION, S.FECHA_MODIFICACION FROM SUCURSAL S
...
AS
BEGIN
	INSERT INTO SUCURSAL( CODIGO, ID_NEGOCIO, NOMBRE_SUCURSAL, DIRECCION_SUCURSAL, UBICACION_SUCURSAL, CIUDAD_SUCURSAL, ESTADO, USUARIO_CREACION, FECHA_CREACION)
	VALUES (@Codigo, @Id_Negocio, @Nombre, @Direccion, @Ubicacion, @Ciudad, @Estado, @Usuario_Creacion, GETDATE());
...
AS
BEGIN
    UPDATE SUCURSAL SET NOMBRE_SUCURSAL = @Nombre, DIRECCION_SUCURSAL = @Direccion, UBICACION_SUCURSAL = @Ubicacion, CIUDAD_SUCURSAL = @Ciudad, 
    ESTADO = @Estado, USUARIO_MODIFICACION = @Usuario_Modificacion, FECHA_MODIFICACION = GETDATE() WHERE ID_SUCURSAL = @Id_Sucursal;
END;
GO
...
INSERT INTO SUCURSAL (ID_NEGOCIO, CODIGO, NOMBRE_SUCURSAL, DIRECCION_SUCURSAL, UBICACION_SUCURSAL, CIUDAD_SUCURSAL, ESTADO, USUARIO_CREACION) 
VALUES (1, '7247', 'SUCURSAL_9 DE OCT y LOS RIOS','AV. 9 DE OCTUBRE 803 Y LOS RIOS',geography::Point(-2.187746,-79.894365, 4326),'Guayaquil',1, 1);
GO
INSERT INTO SUCURSAL (ID_NEGOCIO, CODIGO, NOMBRE_SUCURSAL, DIRECCION_SUCURSAL, UBICACION_SUCURSAL, CIUDAD_SUCURSAL, ESTADO, USUARIO_CREACION) 
VALUES (1, '6584','SUCURSAL_ALBANBORJA','AV.CARLOS JULIO AROSEMENA S/N',geography::Point(-2.169321,-79.917047, 4326),'Guayaquil',0, 1);
GO
...
BEGIN
    ...
    CORREO_ELECTRONICO LIKE @SearchTerm OR CONVERT(VARCHAR(10), FECHA_CREACION, 23) LIKE @SearchTerm OR CASE WHEN ESTADO = 1 THEN 'Activo' ELSE 'Inactivo' END LIKE @SearchTerm);
...
AS
BEGIN
	SELECT ID_PROVEEDOR, CODIGO, NOMBRES, APELLIDOS, CEDULA, TELEFONO, CORREO_ELECTRONICO, ESTADO, USUARIO_CREACION, FECHA_CREACION, USUARIO_MODIFICACION, FECHA_MODIFICACION FROM PROVEEDOR
...
AS
BEGIN
	INSERT INTO PROVEEDOR(CODIGO, NOMBRES, APELLIDOS, CEDULA, TELEFONO, CORREO_ELECTRONICO, ESTADO, USUARIO_CREACION, FECHA_CREACION) 
	values(@Codigo, @Nombres, @Apellidos, @Cedula, @Telefono, @Correo_Electronico, @Estado, @Usuario_Creacion, GETDATE());
END;
GO
...
AS
BEGIN
	UPDATE PROVEEDOR set NOMBRES = @Nombres, APELLIDOS = @Apellidos, CEDULA = @Cedula, TELEFONO = @Telefono, CORREO_ELECTRONICO = @Correo_Electronico, 
    ESTADO = @Estado, USUARIO_MODIFICACION = @Usuario_Modificacion, FECHA_MODIFICACION = GETDATE() WHERE ID_PROVEEDOR = @Id_Proveedor;
END;
GO
...
CREATE VIEW VW_TRANSPORTISTA AS
SELECT
    ID_TRANSPORTISTA, 
    CODIGO, 
    NOMBRES, 
...
AS
BEGIN
	SELECT ID_TRANSPORTISTA, CODIGO, NOMBRES, APELLIDOS, CEDULA, TELEFONO, CORREO_ELECTRONICO, FOTO , ESTADO, USUARIO_CREACION, FECHA_CREACION, USUARIO_MODIFICACION, FECHA_MODIFICACION FROM TRANSPORTISTA
...
AS
BEGIN
	INSERT INTO TRANSPORTISTA(CODIGO, NOMBRES, APELLIDOS, CEDULA, TELEFONO, CORREO_ELECTRONICO, FOTO, ESTADO, USUARIO_CREACION, FECHA_CREACION) 
	values(@Codigo, @Nombres, @Apellidos, @Cedula, @Telefono, @Correo_Electronico, @Foto, @Estado, @Usuario_Creacion, GETDATE());
END;
GO
...
AS
BEGIN
	UPDATE TRANSPORTISTA set NOMBRES = @Nombres, APELLIDOS = @Apellidos, CEDULA = @Cedula, TELEFONO = @Telefono, CORREO_ELECTRONICO = @Correo_Electronico, 
    FOTO = @Foto, ESTADO = @Estado, USUARIO_MODIFICACION = @Usuario_Modificacion, FECHA_MODIFICACION = GETDATE() WHERE ID_TRANSPORTISTA = @Id_Transportista;
END;
GO
...
AS
BEGIN
	SELECT ID_CLIENTE, CODIGO, NOMBRES, APELLIDOS, CEDULA, TELEFONO, CORREO_ELECTRONICO, USUARIO_CREACION, FECHA_CREACION, USUARIO_MODIFICACION, FECHA_MODIFICACION FROM CLIENTE
...
AS
BEGIN
	INSERT INTO CLIENTE(CODIGO, NOMBRES, APELLIDOS, CEDULA, TELEFONO, CORREO_ELECTRONICO, USUARIO_CREACION, FECHA_CREACION) 
	values(@Codigo, @Nombres, @Apellidos, @Cedula, @Telefono, @Correo_Electronico, @Usuario_Creacion, GETDATE());
END;
GO
...
AS
BEGIN
	UPDATE CLIENTE set NOMBRES = @Nombres, APELLIDOS = @Apellidos, CEDULA = @Cedula, TELEFONO = @Telefono, CORREO_ELECTRONICO = @Correo_Electronico,
    USUARIO_MODIFICACION = @Usuario_Modificacion, FECHA_MODIFICACION = GETDATE() WHERE ID_CLIENTE = @Id_Cliente;
END;
GO
...
CREATE PROCEDURE PA_LISTA_CATEGORIA_PAGINACION(     
    ...
    OR CASE WHEN ESTADO = 1 THEN 'Activo' ELSE 'Inactivo' END LIKE @SearchTerm);      
...
AS
BEGIN
    SELECT ID_CATEGORIA, CODIGO, NOMBRE_CATEGORIA, ESTADO, USUARIO_CREACION, FECHA_CREACION, USUARIO_MODIFICACION, FECHA_MODIFICACION FROM CATEGORIA
...
AS
BEGIN
    INSERT INTO CATEGORIA (CODIGO, NOMBRE_CATEGORIA, ESTADO, USUARIO_CREACION, FECHA_CREACION) VALUES (@Codigo, @Nombre, @Estado, @Usuario_Creacion, GETDATE());
END;
GO
...
AS
BEGIN
    UPDATE CATEGORIA SET NOMBRE_CATEGORIA = @Nombre, ESTADO = @Estado, USUARIO_MODIFICACION = @Usuario_Modificacion, 
    FECHA_MODIFICACION = GETDATE() WHERE ID_CATEGORIA = @Id_Categoria;
END;
GO
...
INSERT INTO CATEGORIA(CODIGO, NOMBRE_CATEGORIA, ESTADO, USUARIO_CREACION) VALUES ('6564', 'Frutas y Verduras',1, 1),
('7845', 'Despensa',1, 1),
('1247', 'Preparados',1, 1),
('0786', 'Bebidas y Licores',1, 1),
('3472', 'Refrigerados',1, 1),
('1308', 'Congelados',1, 1),
('6832', 'Carnes',1, 1),
('1375', 'Embutidos',1, 1),
('3529', 'Panaderia',1, 1),
('4839', 'Mascotas',1, 1),
('3098', 'Cuidado Personal',1, 1),
('4802', 'Cuidado del Hogar',1, 1),
('6796', 'Electrodomésticos',1, 1),
('1378', 'Jarnideria y Plantas',1, 1);

--Modulo Producto Tabla-Procedimientos almacenados-Vista
...
BEGIN
    ...
    CASE WHEN ESTADO = 1 THEN 'No Agotado' ELSE 'Agotado' END LIKE @SearchTerm);
...
AS
BEGIN
	SELECT ID_PRODUCTO, P.CODIGO, DESCRIPCION, NOMBRE_PRODUCTO, C.ID_CATEGORIA, C.NOMBRE_CATEGORIA, PAIS_ORIGEN, P.ESTADO, P.USUARIO_CREACION, P.FECHA_CREACION, P.USUARIO_MODIFICACION, P.FECHA_MODIFICACION FROM PRODUCTO P
	inner join CATEGORIA C on P.ID_CATEGORIA = C.ID_CATEGORIA
...
AS
BEGIN
	INSERT INTO PRODUCTO(CODIGO, DESCRIPCION, NOMBRE_PRODUCTO, ID_CATEGORIA, PAIS_ORIGEN, ESTADO, USUARIO_CREACION, FECHA_CREACION) 
	values(@Codigo, @Descripion, @Nombre_Producto, @Id_Categoria, @Pais_Origen, @Estado, @Usuario_Creacion, GETDATE());
END;
GO
...
AS
BEGIN
	UPDATE PRODUCTO SET DESCRIPCION = @Descripion, NOMBRE_PRODUCTO = @Nombre_Producto, ID_CATEGORIA = @Id_Categoria, PAIS_ORIGEN = @Pais_Origen, ESTADO  = @Estado, USUARIO_MODIFICACION = @Usuario_Modificacion , FECHA_MODIFICACION = GETDATE() WHERE ID_PRODUCTO = @Id_Producto;
END;
GO
...
AS
BEGIN
	INSERT INTO OFERTA(CODIGO, NOMBRE_OFERTA, ID_PRODUCTO, DESCRIPCION, FECHA_INICIO, FECHA_FIN, DESCUENTO, ESTADO, USUARIO_CREACION, FECHA_CREACION) 
	values(@Codigo, @Nombre_Oferta, @Id_Producto, @Descripcion, @Fecha_Inicio, @Fecha_Fin, @Descuento, @Estado, @Usuario_Creacion, GETDATE());
END;
GO
...
AS
BEGIN
	UPDATE OFERTA set NOMBRE_OFERTA = @Nombre_Oferta, ID_PRODUCTO = @Id_Producto, DESCRIPCION = @Descripcion, FECHA_INICIO = @Fecha_Inicio, 
    FECHA_FIN = @Fecha_Fin, DESCUENTO = @Descuento, ESTADO = @Estado, USUARIO_MODIFICACION = @Usuario_Modificacion, FECHA_MODIFICACION = GETDATE() WHERE ID_OFERTA = @Id_Oferta;
END;
GO
...
END;
GO
CREATE PROCEDURE PA_ACTUALIZAR_ESTADO_OFERTAS
AS
BEGIN
    SET NOCOUNT ON;
...
--Modulo Compra Tablas-Tabla intermedia-Procedimientos almacenados-Trigger
...
SELECT
    ...
    P.NOMBRES AS NOMBRES_PROVEEDOR,
    P.APELLIDOS AS APELLIDOS_PROVEEDOR,
    P.CEDULA AS CEDULA_PROVEEDOR,

    -- Transportista
    T.ID_TRANSPORTISTA,
    T.CODIGO AS CODIGO_TRANSPORTISTA,
    T.NOMBRES AS NOMBRES_TRANSPORTISTA,
    T.APELLIDOS AS APELLIDOS_TRANSPORTISTA,
    T.CEDULA AS CEDULA_TRANSPORTISTA,

    -- Valores
    C.MONTO_TOTAL,
    CONVERT(CHAR(10), C.FECHA_COMPRA, 103) AS FECHA_COMPRA
...
BEGIN
    ...
    BEGIN TRY
        ...
        SET 
            ...
            P.USUARIO_MODIFICACION = U.CODIGO,
...
CREATE TRIGGER TR_PRODUCTO_HISTORIAL_PRECIO
ON PRODUCTO
AFTER UPDATE
AS
BEGIN
    ...
    INSERT INTO HISTORIAL_PRECIO_PRODUCTO(ID_PRODUCTO, PRECIO_COMPRA_ANTERIOR, PRECIO_COMPRA_NUEVO, PRECIO_VENTA_ANTERIOR, PRECIO_VENTA_NUEVO, USUARIO_MODIFICACION)
    SELECT 
        I.ID_PRODUCTO,
        D.PRECIO_COMPRA,
        I.PRECIO_COMPRA,
    ...
    WHERE
        ISNULL(I.PRECIO_COMPRA, 0) <> ISNULL(D.PRECIO_COMPRA, 0)
        OR ISNULL(I.PRECIO_VENTA, 0) <> ISNULL(D.PRECIO_VENTA, 0);
END;
GO
...
SELECT
    ...
    V.MONTO_TOTAL,
    V.DESCUENTO,
    CONVERT(CHAR(10), V.FECHA_VENTA, 103) AS FECHA_VENTA
...
BEGIN
    ...
    WHERE (@Filtro = '' OR CODIGO LIKE @SearchTerm OR ENDPOINT LIKE @SearchTerm OR METODO LIKE @SearchTerm OR NIVEL LIKE @SearchTerm OR 
    CONVERT(VARCHAR(10), FECHA, 23) LIKE @SearchTerm);      

	SELECT ID_LOG, CODIGO, MENSAJE, DETALLE, ID_USUARIO, FECHA, ENDPOINT, METODO, NIVEL FROM LOG
    WHERE (@Filtro = '' OR CODIGO LIKE @SearchTerm OR ENDPOINT LIKE @SearchTerm OR METODO LIKE @SearchTerm OR NIVEL LIKE @SearchTerm OR
    CONVERT(VARCHAR(10), FECHA, 23) LIKE @SearchTerm)
...
AS
BEGIN
	SELECT ID_LOG, CODIGO, MENSAJE, DETALLE, ID_USUARIO, FECHA, ENDPOINT, METODO, NIVEL FROM LOG WHERE ID_LOG = @Id_Log;
END;
...
AS
BEGIN
    INSERT INTO LOG (Codigo, Mensaje, Detalle, ID_Usuario, ENDPOINT, METODO, NIVEL)
    VALUES (@Codigo, @Mensaje, @Detalle, @ID_Usuario, @EndPoint, @Metodo, @Nivel);
END;
GO
...
CREATE TABLE HISTORIAL_PRECIO_PRODUCTO (
    ...
    PRECIO_COMPRA_NUEVO DECIMAL(10, 2) NULL,
...
EXEC dbo.PA_LISTA_PRODUCTO_PAGINACION;