...
BEGIN
    ...
    DIRECCION_SUCURSAL, UBICACION_SUCURSAL.Lat AS LATITUD, UBICACION_SUCURSAL.Long AS LONGITUD, CIUDAD_SUCURSAL, ESTADO FROM SUCURSAL S
...
AS
BEGIN
	SELECT ID_PROVEEDOR, CODIGO, NOMBRES, APELLIDOS, CEDULA, TELEFONO, CORREO_ELECTRONICO, ESTADO, FECHA_CREACION FROM PROVEEDOR
...
AS
BEGIN
	SELECT ID_TRANSPORTISTA, CODIGO, NOMBRES, APELLIDOS, CEDULA, TELEFONO, CORREO_ELECTRONICO, FOTO ,ESTADO, FECHA_CREACION FROM TRANSPORTISTA
...
AS
BEGIN
	SELECT ID_CLIENTE, CODIGO, NOMBRES, APELLIDOS, CEDULA, TELEFONO, CORREO_ELECTRONICO, FECHA_CREACION FROM CLIENTE
